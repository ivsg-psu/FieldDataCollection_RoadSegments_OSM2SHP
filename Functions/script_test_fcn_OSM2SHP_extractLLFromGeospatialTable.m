%% script_test_fcn_OSM2SHP_extractLLFromGeospatialTable
...
%% DEMO case: Extract the LL coordinates of OSM State College road segments
...
% Call the function
[LLCoordinate_allSegments, LL_allSegments_cell] = fcn_OSM2SHP_extractLLFromGeospatialTable(geospatial_table, ([]));
